...
import { loadProductModel, getLightColors, getCameraViews, applyProductSelection } from './OldProductModel';
...
export default function Scene() {
    ...
    // Keep a ref to the latest `selected` so we can apply it to the model when it loads
